...
Что именно cdc-1c создаёт в вашей базе: таблицы данных, служебные поля строк и служебные таблицы,
по которым видно состояние загрузки. Читать это нужно тем, кто пишет запросы к целевой БД или
