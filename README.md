...
| [README_API.md](README_API.md) | классы, которые собирает пользователь: `Replicator1C`, `Handler1C`, `HandlerLoop`, `FullLoadCron` |
| [README_DB.md](README_DB.md) | что появляется в целевой БД: таблицы, служебные поля, служебные таблицы |
| [README_HANDLERS.md](README_HANDLERS.md) | обработчики: окно изменений, когда их зовут, пересборка витрины, что помнить |
| [DESIGN.md](DESIGN.md) | внутреннее устройство для тех, кто правит код: пагинация, нарезка выгрузки, гонки со снимком |
